...
public class OptionsMenu : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (PlayerPrefs.HasKey("sound")) soundOutput.text = Mathf.Round(PlayerPrefs.GetFloat("sound") * 10).ToString();
        else
        {
        ...
        if (PlayerPrefs.HasKey("music")) soundOutput.text = Mathf.Round(PlayerPrefs.GetFloat("music") * 10).ToString();
        else
        {
    ...
    public void RefreshTheme()
    {
        ...
        if (!AudioManager.instance.IsPlaying(theme.songTitle))
        {
